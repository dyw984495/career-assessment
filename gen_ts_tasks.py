#!/usr/bin/env python3
"""Generate taskDetails.ts - TypeScript file with all task details."""
...
output = '''// Auto-generated from 岗位库.xlsx - 典型任务列
...
print(f"Generated src/assessment/taskDetails.ts with {len(task_details)} roles")
